...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React37 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState18 = React37.useState, useEffect18 = React37.useEffect, useLayoutEffect5 = React37.useLayoutEffect, useDebugValue2 = React37.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React37 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef19 = React37.useRef, useEffect18 = React37.useEffect, useMemo6 = React37.useMemo, useDebugValue2 = React37.useDebugValue;
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/primitive/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-context/dist/index.mjs
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      const Context = ((_a5 = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a5[index]) || BaseContext;
      const value = React2.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-id/dist/index.mjs
var React4 = __toESM(require_react(), 1);

// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
...
var FocusScope = React13.forwardRef((props, forwardedRef) => {
  ...
  const [container8, setContainer] = React13.useState(null);
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
...
// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/Combination.js
var React19 = __toESM(require_react());

// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/UI.js
var React17 = __toESM(require_react());

// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/medium.js
...
// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/SideEffect.js
var React18 = __toESM(require_react());

// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/aggresiveCapture.js
...
// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/handleScroll.js
...
// node_modules/@mysten/dapp-kit/node_modules/react-remove-scroll/dist/es2015/sidecar.js
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime7.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React20.Children.map(children, (child) => (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime7.jsx)(Portal, { asChild: true, container: container8, children: child }) })) });
};
    ...
    __privateAdd3(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) {
        try {
          ...
          if (accounts.length) {
            __privateMethod3(this, _SlushWallet_instances, setAccounts_fn).call(this, accounts);
          }
        } catch (error) {
        }
      ...
      __privateMethod3(this, _SlushWallet_instances, setAccounts_fn).call(this, await getAccountsFromSession(response.session));
      return { accounts: this.accounts };
    });
...
async function registerSlushWallet(name, {
  ...
  if (!(metadata == null ? void 0 : metadata.enabled)) {
  ...
  const unregister = wallets2.register(slushWalletInstance);
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-direction/dist/index.mjs
...
var DismissableLayerContext2 = React27.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var DismissableLayer2 = React27.forwardRef(
  (props, forwardedRef) => {
    const {
      disableOutsidePointerEvents = false,
      onEscapeKeyDown,
    ...
    const context = React27.useContext(DismissableLayerContext2);
...
var DismissableLayerBranch2 = React27.forwardRef((props, forwardedRef) => {
  const context = React27.useContext(DismissableLayerContext2);
...
var FocusScope2 = React28.forwardRef((props, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
    onMountAutoFocus: onMountAutoFocusProp,
  ...
  const [container8, setContainer] = React28.useState(null);
  const onMountAutoFocus = useCallbackRef(onMountAutoFocusProp);
  const onUnmountAutoFocus = useCallbackRef(onUnmountAutoFocusProp);
...
// node_modules/@mysten/dapp-kit/node_modules/@radix-ui/react-use-size/dist/index.mjs
var React30 = __toESM(require_react(), 1);
function useSize(element) {
  const [size2, setSize] = React30.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    const [content4, setContent] = React31.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [arrow2, setArrow] = React31.useState(null);
...
var Portal3 = React32.forwardRef((props, forwardedRef) => {
  var _a5;
  const { container: containerProp, ...portalProps } = props;
...
var Menu = (props) => {
  ...
  const [content4, setContent] = React35.useState(null);
...
toLegacyAddress_fn = function() {
  const legacyBytes = normalizeZkLoginPublicKeyBytes(__privateGet5(this, _data), true);
...
var StyleMarker = (0, import_react7.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime22.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
  ...
  ({
    ...
    return (0, import_jsx_runtime23.jsx)(
      Slot,
      {
        ...headingProps,
        ref: forwardedRef,
        className: clsx_default(headingVariants({ size: size2, weight, truncate }), className),
...
var Button = (0, import_react10.forwardRef)(
  ({ className, variant: variant2, size: size2, asChild = false, ...props }, forwardedRef) => {
    const Comp = asChild ? Slot : "button";
    return (0, import_jsx_runtime25.jsx)(
      Comp,
      {
        ...props,
        className: clsx_default(buttonVariants({ variant: variant2, size: size2 }), className),
        ref: forwardedRef
      }
    );
  }
...
var Text = (0, import_react11.forwardRef)(
  ({
    children,
    className,
    asChild = false,
    ...
    return (0, import_jsx_runtime26.jsx)(
      Slot,
      {
        ...textProps,
        ref: forwardedRef,
        className: clsx_default(textVariants({ size: size2, weight, color, mono }), className),
...
var SuiClientContext = (0, import_react14.createContext)(null);
...
function SuiClientProvider(props) {
  ...
  const [selectedNetwork, setSelectedNetwork] = (0, import_react14.useState)(
...
function useSuiClientContext() {
  const suiClient = (0, import_react13.useContext)(SuiClientContext);
  if (!suiClient) {
    throw new Error(
...
function useSuiClientSuspenseQuery(...args) {
  ...
  const suiContext = useSuiClientContext();
  const query = (0, import_react12.useMemo)(() => {
...
function useAutoConnectWallet() {
  ...
  const [clientOnly, setClientOnly] = (0, import_react16.useState)(false);
